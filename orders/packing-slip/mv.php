    ...
    <section id="wrapper">
      ...
      <div class="row row-bordered round-corners">
        ...
        <div class="row">
          ...
          <div class="col-3">
            <span class="red-text text-medium"><b>Customer Contact: </b></span>Lana
          </div>
          <div class="col-3">
            <span class="red-text text-medium"><b>Customer Account #: </b></span>1300
          </div>
        </div>
        ...
        <thead>
          ...
          <tbody>
            <?php
              ...
              $crateDesc = "";
              //Query orders
              $result = $conn->query("SELECT * FROM mv_packing_slip ORDER BY order_number ASC");
